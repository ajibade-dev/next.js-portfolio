...
const Homepage = () => {
  return <div className="h-full flex flex-col lg:flex-row-reverse px-4 sm:px-8 md:px-12 lg:px-20 xl:px-30">
 {/* Image Container */}
 ...
 <div className="h-1/2 lg:h-full lg:w-1/2 flex flex-col gap-8 items-center justify-center">
  {/* title */}
  <h1 className="text-4xl md:text-6xl font-bold mt-20 lg:mt-0 text-slate-800">Crafting Digital Experiences, Designing Tommorow</h1>
  {/* description */}
